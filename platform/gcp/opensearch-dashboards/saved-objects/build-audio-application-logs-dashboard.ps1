...
Add-Header "audio-group-demand" "2. HTTP 오류 분석"
...
Add-Header "audio-group-performance" "3. 작업 추적 근거"
...
$panelSpecs = @(
  ...
  @("visualization", "audio-group-errors", 0, 5, 48, 2),
  @("visualization", "audio-errors-by-code", 0, 7, 24, 10), @("visualization", "audio-errors-by-app", 24, 7, 24, 10),
  @("search", "audio-top-retried-jobs", 0, 17, 24, 11), @("search", "audio-recent-failed-requests", 24, 17, 24, 11),
  @("visualization", "audio-group-demand", 0, 28, 48, 2),
  @("visualization", "audio-http-error-routes", 0, 30, 16, 10), @("visualization", "audio-http-errors-over-time", 16, 30, 16, 10), @("search", "audio-recent-http-errors", 32, 30, 16, 10),
  @("visualization", "audio-group-performance", 0, 40, 48, 2),
  @("search", "audio-recent-transcode-failures", 0, 42, 24, 12), @("search", "audio-recent-transcode-completed", 24, 42, 24, 12)
)
